				...
				<div class="user-info-dropdown">
					<div class="dropdown">
						...
						>
                            ...
                            <span class="user-name">{{ Auth::guard('etudiants')->user()->nom }}</span>
                        @elseif(Auth::guard('clients')->check())
                            <span class="user-name">{{ Auth::guard('clients')->user()->nom }}</span>
                        @endif
				...
				<div class="right-sidebar-body-content">
					...
					<div class="reset-options pt-30 text-center">
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('truncate.truncate') }}">
                                    <button type="button" class="btn btn-danger">
                                        <i class="bi bi-exclamation-triangle-fill"></i> Truncate Table
                                    </button>
                                </a>
                            </li>
                        </ul>
			...
			<div class="brand-logo">
				<a href="index.html">
                    ...
                    <div class="logo-container">
                        <img
                            src="{{asset('vendors/images/logo.png')}}"
                            alt="Logo"
                            class="light-logo"
                        />
                    </div>
				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
                                @if (Auth::guard('admins')->check() && Auth::guard('admins')->user()->isAdmin())
                                    <li><a href="{{ route('etudiant.getetudiant') }}">Lists of Students</a></li>
                                @endif
                                @if (Auth::guard('etudiants')->check() && Auth::guard('etudiants')->user()->isEtudiant())
                                    <li><a href="{{ route('semestre.getsemestre', ['etudiantsId' => Auth::guard('etudiants')->user()->idetudiant]) }}">Lists of Semester</a></li>
                                @endif
                            </ul>
						...
						<li class="dropdown">
							...
							<ul class="submenu">
                                @if (Auth::guard('admins')->check() && Auth::guard('admins')->user()->isAdmin())
                                        <li><a href="{{route('note.notepage')}}">Add note</a></li>
                                        <li><a href="{{route('import.importpage')}}">Import CSV file</a></li>
                                        <li><a href="{{route('config.configpage')}}">Config note</a></li>
                                @endif
							</ul>
						</li>
                        <li class="dropdown">
							...
							<ul class="submenu">
                                @if (Auth::guard('admins')->check() && Auth::guard('admins')->user()->isAdmin())
                                        <li><a href="{{route('ajour.getnbretudiantAjourLicence')}}">Dashboard</a></li>
                                @endif
							</ul>
						</li>
						<li class="dropdown">
		...
		<div class="main-container">
			...
			<div class="xs-pd-20-10 pd-ltr-20">
				{{-- <div class="title pb-20">
					<h2 class="h3 mb-0">Welcome to Mobiliar Agency</h2>
				</div> --}}
